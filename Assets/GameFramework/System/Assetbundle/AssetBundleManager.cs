...
{	
    ...
    public class AssetBundleManager : MonoBehaviour
    {
       ...
       static GameObject AssetBundleManagerObj;
        // Load AssetBundleManifest.
        static void InitializeAbs()
        {
#if UNITY_EDITOR
            Log(LogType.Info, "Simulation Mode: " + (SimulateAssetBundleInEditor ? "Enabled" : "Disabled"));
#endif

            AssetBundleManagerObj = new GameObject("AssetBundleManager", typeof(AssetBundleManager));
            DontDestroyOnLoad(AssetBundleManagerObj);
